...
export default class Inscrire extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('https://examyunisuback.herokuapp.com/particulier', obj)
    ...
    componentDidMount() {
        axios.get(`https://examyunisuback.herokuapp.com/article/${localStorage.atel}`)
            .then(response => {
      ...
      {console.log('this.state.profil.titre ' , this.state.profil.titre  )
                  ...
                  <div className=' ' >
                    <div className='inscri col-md-5 col-6' >
                        <img width="300px" height="300px" src={'https://examyunisuback.herokuapp.com/photos/'+this.state.profil.photo_profil} alt="pdp" />
                    </div>
            ...
            <div className='container'>
              <div className='col'>
                ...
                <div className='col-md-5 col2'> 
                  <p>{this.state.profil.description}</p>
                  <img width="100%" height="100%" src={'https://examyunisuback.herokuapp.com/photos/'+this.state.profil.photo_profil} alt="pdp" />
                </div>
