...
export default class Edit extends Component {
  ...
  componentDidMount() {
      axios.get('https://examyunisuback.herokuapp.com/article/'+this.props.match.params.id)
          .then(response => {
                this.setState({ 
  ...
  onSubmit(e) {
    ...
    axios.post('https://examyunisuback.herokuapp.com/article/'+this.props.match.params.id, obj)
