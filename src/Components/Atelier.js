...
class Accueil extends Component {
    ...
    componentDidMount() {
        axios.get('https://examyunisuback.herokuapp.com/article')
            .then(response => {
                                    ...
                                    return (
                                        ...
                                        <div className='col-md-3'>
                                            <MDBCard id='carte' key={obj._id} onClick={() => this.inscrire(obj._id)}>
                                                <MDBCardImage id='' cascade className=" img-fluid" src={'https://examyunisuback.herokuapp.com/photos/' + obj.photo_profil} alt="pdp" />
                                                <MDBCardBody cascade>
