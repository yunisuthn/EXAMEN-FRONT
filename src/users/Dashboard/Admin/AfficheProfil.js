...
export default class AfficheProfil extends React.Component {
    ...
    componentDidMount() {
        axios.get(`https://examyunisuback.herokuapp.com/userArticle/${localStorage.id}`)
            .then(response => {
    ...
    activer() {
        axios.post(`https://examyunisuback.herokuapp.com/activer/${localStorage.id}`)
            .then(response => {
            ...
            <tbody>
                {
                    (this.state.profil.length > 0) ? (this.state.profil.map((obj) => {
                        ...
                        return <tr key={obj._id}>
                            ...
                            <td>
                                <img width="150px" height="50px" src={'https://examyunisuback.herokuapp.com/photos/' + obj.photo_profil} alt="pdp" />
                            </td>
                            <td>
